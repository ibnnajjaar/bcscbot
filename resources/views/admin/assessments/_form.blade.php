<div class="p-8">
    ...
    <div class=" mb-4">
        ...
        <x-select name="weekday">
            @foreach ($weekdays as $weekday)
                <option value="{{ $weekday}}" {{ $assessment->weekday == $weekday ? 'selected' : '' }}>{{ \Illuminate\Support\Str::title($weekday) }}</option>
            @endforeach
        </x-select>
    ...
    <div class=" mb-4">
        ...
        <x-textarea name="details">{{ $assessment->details }}</x-textarea>
